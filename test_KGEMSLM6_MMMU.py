...
parser.add_argument("--image-folder", type=str, default="/home/gtl/LLaVA-main/playground/data/MMMU_img/")
parser.add_argument("--question-file", type=str, default="./playground/data/mmmu_questions.json")
...
f=open('dataset_output_mmmu.json', 'r', encoding='utf-8') 
alldata = json.load(f)
...
# 保存dataset为json文件
with open('dataset_output_mmmu2.json', 'w', encoding='utf-8') as f:
